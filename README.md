...
- โน้ตพร้อมคีย์เวิร์ด (`***keyword: เนื้อหา`) เรียกกลับดูด้วยคีย์เวิร์ด
...
| `***โน้ต` | บันทึกโน้ต |
| `***keyword: เนื้อหา` | บันทึกโน้ตพร้อมคีย์เวิร์ด (เช่น `***wifi: รหัสผ่านคือ 1234`) |
| `ดู wifi` / `#wifi` / `wifi` | เรียกดูโน้ตที่บันทึกด้วยคีย์เวิร์ด `wifi` |
