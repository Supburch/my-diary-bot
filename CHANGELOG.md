...
### หมายเหตุ
- Deploy บน Render สำเร็จ (2026-08-19) — migration 003 รันอัตโนมัติผ่าน `alembic upgrade head` ใน `startCommand` เพื่อ drop คอลัมน์ `keyword`
- เทสต์ทั้งหมดผ่าน: 48 passed
